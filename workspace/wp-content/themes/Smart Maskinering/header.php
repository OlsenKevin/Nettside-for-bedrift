...
<div class="header-top cf">
		...
		if ( get_theme_mod( 'ti_header_logo', get_template_directory_uri()."/images/logo.png" ) ) {
			?>
			<a href="<?php echo "https://smartmaskinering-ttgmagnus.c9users.io/hjem/"; ?>" title="<?php bloginfo( 'title' ); ?>" id="logo">
...
<nav>
	...
	<ul class="navigation-socials">
		<li><a href="<?php echo get_theme_mod( 'ti_header_facebook_link1', 'http://www.facebook.com' ); ?>" title="<?php _e( 'Facebook', 'medica_lite' ); ?>" class="facebook-icon" target="_blank"></a></li>
		<li><a href="<?php echo get_theme_mod( 'ti_header_linkdin_link1', 'http://www.linkedin.com' ); ?>" title="<?php _e( 'Linkedin', 'medica_lite' ); ?>" class="linkdin-icon" target="_blank"></a></li>
	</ul>
	<!--/.navigation-socials-->
